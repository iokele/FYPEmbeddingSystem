package com.fypembeddingapplication.embeddingapplication.EmbeddingAlgorithm.MosaicFilter.PixelUtils;
    ...
    public static int combinePixels(int rgb1, int rgb2, int op, int extraAlpha) {
        ...
        switch (op) {
            ...
            case COLOR:
                ...
                rgb1 = Color.HSBtoRGB(hsb2[0],hsb2[1],hsb2[2]); ///Edit to HSBtoRGB, bright change to value
                r1 = (rgb1 >> 16) & 0xff;
                g1 = (rgb1 >> 8) & 0xff;
                b1 = rgb1 & 0xff;
                break;
