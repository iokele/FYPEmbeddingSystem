package com.fypembeddingapplication.embeddingapplication.EmbeddingAlgorithm.MosaicFilter.ImageMath;
...
*/
    ...
    public static int mixColors(float t, int rgb1, int rgb2,int alpha) {
     ...
     * @param nw,ne,sw.se array of four ARGB values in the order NW, NE, SW, SE
     * @return the interpolated value
     */
